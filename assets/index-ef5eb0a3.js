...
for (let e = 0; e < 12; e++) l.push(`assets/home (${e + 1}).jpeg`);
let u = [
    "Rome, Italy",
    "Sydney, Australia",
    "London, England",
  ...
  r = [];
for (let e = 0; e < 12; e++) r.push(Math.floor(Math.random() * 15) + 35);
for (let e = 0; e < 12; e++)
  f.innerHTML += `<div class="card m-auto">
      <img
      src="${l[e]}"
      alt=""
...
let m = document.getElementById("icons"),
  c = [],
  p = [
    "Rooms",
    "Tropical",
...
for (let e = 0; e < 24; e++) c.push(`assets/icon (${e + 1}).jpg`);
for (let e = 0; e < 24; e++)
  m.innerHTML += `<li
...
function g() {
  o.classList.contains("dark")
    ? o.classList.remove("dark")
    : o.classList.add("dark");
}
let h = document.getElementById("dark-toggle");
